...
(defun install-style-check-package ()
  ...
  (if (not (string-match "\\(flake8\\)" pip-list-packages))
      (shell-command "pip install anaconda-mode flake8 ipython flake8-bugbear flake8-todo flake8-tabs flake8-quotes flake8-import-order pep8-naming flake8-mypy flake8-comprehensions ipdb hy")))
